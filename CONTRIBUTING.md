...
2. Run `make install` to install skills locally into `$CODEX_HOME/skills` (or `~/.codex/skills` when unset), `~/.claude/skills`, `~/.agents/skills`, `~/.gemini/skills`, `~/.cursor/skills`, and `~/.copilot/skills`.
